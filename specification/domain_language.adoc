...
a. significant improvement in adherence to a clear separation of
concerns

a. clearly delineated architectural layers and services provided as
interfaces

a. significantly enhanced extensibility
